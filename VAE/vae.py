...
class ConvVAE(BaseVAE):
    ...
    def __init__(self, input_size=(3, 64, 64),
        ...
        self.conv_encoder = utils.create_cnn2d(
        ...
        self.features_to_hidden = utils.create_mlp(
        ...
        self.latent_to_features = utils.create_mlp(
            dim_z, [hidden_size, self.flat_conv_output_size])
        # initialize decoder layers
        self.conv_decoder = utils.create_transpose_cnn2d(
        ...
        if binary:
            ...
            self.conv_decoder_logvar = utils.create_transpose_cnn2d(
                self.channel_sizes[-1], self.channel_sizes[-2:0:-1], (4,4), 2, 1, 0)
